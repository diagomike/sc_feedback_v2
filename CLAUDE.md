...
Feedback.dc.html` (copied verbatim from v1) is the Claude Design handoff — 16 screens.
...
**Full plan**: `C:\Users\pc\.claude\plans\i-want-to-rebuild-shimmying-spring.md` (this
...
- **Dev server on :4300** — v1's ports (4001 API / 4173 web) are left free;
  `.claude/launch.json` has one `web` entry.
...
Browser verification via `preview_start` against `.claude/launch.json`'s `web` entry
